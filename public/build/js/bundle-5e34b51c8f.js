...
exports.default = {
    ...
    methods: {
        showConfirm: function showConfirm() {
            ...
            _bootbox2.default.confirm(this.message, function (result) {
                if (result) _this.makeRequest();
            });
        },
        makeRequest: function makeRequest() {
            $.ajax({
                ...
                error: function error(response) {
                    _bootbox2.default.alert(response.responseText);
                },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-baea50e0", module.exports)
  } else {
    hotAPI.update("_v-baea50e0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"bootbox":1,"vue":7,"vue-hot-reload-api":5,"vueify/lib/insert-css":8}],10:[function(require,module,exports){
'use strict';

var _Confirm = require('./components/Confirm.vue');
...
},{"./components/Confirm.vue":9,"bootstrap-sass":2,"jquery":3,"vue":7,"vue-resource":6}]},{},[10]);
